...
import cl.curso.usuarios.logs.LogService;
...
public class UsuarioController {
    ...
    public UsuarioController(UsuarioService usuarioService, JwtService jwtservice, CookieTokenService cookie, LogService logservice) {
    ...
    public ResponseEntity<LoginResponse> login(@Valid @RequestBody LoginRequest peticion) {
        ...
        if (encontrado.isPresent()) {
            ...
            logservice.registrar(LogService.LOGIN_OK, u.getEmail(), "Usuario Exitosamente");
        ...
        logservice.registrar(LogService.LOGIN_FALLIDO, peticion.getEmail(), "Usuario Fallido");
